...
final class GoogleSignInAdapter: @preconcurrency IosGoogleSignInService {
    ...
    init(bundle: Bundle = .main) {
        ...
        if let clientID, clientID.hasSuffix(".apps.googleusercontent.com"),
           let serverClientID, serverClientID.hasSuffix(".apps.googleusercontent.com") {
    ...
    func signIn(googleCallback callback: IosGoogleSignInCallback) {
