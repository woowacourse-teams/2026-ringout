...
private val LoginDarkColors = LoginColors(
    ...
    appleBackground = Color(0xFFFFFFFF),
    appleBorder = Color.Black,
    appleText = Color(0xFF374151),
