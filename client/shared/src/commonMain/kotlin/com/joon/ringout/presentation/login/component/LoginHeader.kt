...
internal fun LoginHeader(
    ...
    Box(
        modifier = modifier
            .fillMaxWidth()
            .height(dimensions.headerContainerHeight),
        ...
        Box(
            ...
            Image(
                painter = painterResource(LoginBackIconResource),
                contentDescription = null,
                modifier = Modifier.size(dimensions.headerVisualHeight),
